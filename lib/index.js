...
var TypeOut = function (_Component) {
  ...
  _createClass(TypeOut, [{
    ...
    key: 'setNewOrder',
    value: function setNewOrder(words, random) {
    ...
    value: function changeWord() {
      ...
      var newOrderWords = this.setNewOrder(words, random, lastWord);
      this.addChar(0, (0, _utils.getFirst)(newOrderWords).length, newOrderWords);
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      var caretNode = caret ? _react2.default.createElement('span', { className: 'react-typeout-caret' }) : null;
